...
SOURCES = \
	__init__.py \
	otp_plugin.py otp_plugin_dialog.py

PLUGINNAME = otp_plugin

PY_FILES = \
	__init__.py \
	otp_plugin.py otp_plugin_dialog.py

UI_FILES = otp_plugin_dialog_base.ui
...
QGISDIR=C:\Users\MarioPC\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
